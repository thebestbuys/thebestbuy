...
const TRANSLATIONS = {
  fr: {
    ...
    'suggestion.phonePhoto': 'Un téléphone pour la photo',
    'suggestion.lightLaptop': 'Un ordinateur portable léger',
    'suggestion.ancHeadphones': 'Un casque avec réduction de bruit',
    'suggestion.gamingPc': 'Un PC pour le gaming',
  ...
  en: {
    ...
    'suggestion.phonePhoto': 'A phone for photography',
    'suggestion.lightLaptop': 'A lightweight laptop',
    'suggestion.ancHeadphones': 'Noise-cancelling headphones',
    'suggestion.gamingPc': 'A gaming PC',
