...
function UserDropdown({ user, onClose, onSignOut, onOpenSelections, onOpenProfile, onOpenFriends }) {
  const { t } = useI18n();
...
export default function AuthMenu({ variant = 'home', onOpenSelections, onOpenProfile, onOpenFriends }) {
